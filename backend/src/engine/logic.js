 ...
 */
function calculateGameScore(basePoints, referenceTime, playerTime) {
 ...
 */
function updateElo(playerElo, avgBucketElo, rank, totalPlayers) {
 ...
 */
function getBasePoints(seDifficulty) {
