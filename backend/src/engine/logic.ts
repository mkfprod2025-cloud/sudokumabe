 ...
 */
export function calculateGameScore(basePoints: number, referenceTime: number, playerTime: number): number {
 ...
 */
export function updateElo(playerElo: number, avgBucketElo: number, rank: number, totalPlayers: number): number {
 ...
 */
export function getBasePoints(seDifficulty: number): number {
